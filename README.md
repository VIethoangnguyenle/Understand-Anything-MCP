...
| `get_node_source` | Đọc mã nguồn thực tế của node. Trích xuất method/class Java theo tên symbol |
| `get_relationships` | Tất cả node liên kết kèm loại quan hệ. Lọc theo hướng và loại relation |
